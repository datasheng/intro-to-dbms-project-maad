...
insert into school(schoolID, schoolName, licenseID,balance)
values('002688','City College',00001,'$0');

-- Updating the tables to add schools info
UPDATE 
student SET schoolID = '002688', schoolName = 'City College'
WHERE studentID = 1;
...
UPDATE 
course SET schoolID = '002688', schoolName = 'City College'
WHERE courseID = 1;
